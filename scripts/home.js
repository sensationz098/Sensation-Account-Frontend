...
const url = `https://final-backend-mark1-2.onrender.com/user/display-and-download?startDate=${formattedStartDate}&endDate=${formattedEndDate}`;
...
console.log(userIds)
const userNameResponse = await fetch(`https://final-backend-mark1-2.onrender.com/user/allusers?id=${userIds.join(',')}`,{
    headers: {
        "Content": 'application/json',
        "Authorization": token
    }
